...
PHASE 1 — Preflight
  ...
  |-- Check kubeconfig + bootstrap-kubeconfig secrets exist on provisioner
...
| `tasks/break_glass_create_credential.yml` | Phase 2 — credential list/create with 403 detection |
